...
This creates the `groups`, `players`, `sessions`, `session_entries`, and
`group_members` tables, the `join_group_with_code()` RPC, all Row Level
Security policies, and adds the tables to the Realtime publication.
